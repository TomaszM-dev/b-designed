  ...
  return (
    <div>
      <motion.div
        ...
        initial="hidden"
        ref={element}
        className="flex flex-col gap-[1rem]  w-[95%] mx-auto items-center mt-[7rem]"
      >
        ...
        <div className="flex items-center my-20  gap-20 w-[90%] mt-6 flex-1  relative  cursor-pointer  rounded-2xl overflow-hidden">
          <motion.div
            variants={scrollLeft}
            animate={controls}
            initial="hidden"
          ...
          >
            ...
            <div className="absolute bottom-0  flex flex-col gap-7 items-center   transition-all  p-10 h-[45%] text-secondary  hover:opacity-100 bg-tertirary group-hover:h-[73%] group ">
          ...
          <motion.div
            ...
            initial="hidden"
            ref={element}
            className="w-full h-[30rem] cursor-pointer  relative  flex  flex-col rounded-2xl  overflow-hidden group"
          >
            <Image
              className="  w-full h-[55%] grayFilter  object-cover  block"
              src={card2}
            ...
            <div className="absolute bottom-0  flex flex-col gap-7 items-center   transition-all  p-10 h-[45%] text-secondary  hover:opacity-100 bg-tertirary group-hover:h-[71%] group ">
              <h2 className="text-[1.3rem] font-[700] text-secondary">
                {" "}
